...
- **Review out.** No unit closes until `/verified-review` passes — the reviewer runs Verify itself, red before / green after. A one-line fix meets the same bar as a Tier 2 ticket.
