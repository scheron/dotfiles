...
**Personal skills live in your runtime's skills directory** — `~/.claude/skills/` on Claude Code. Codex, Copilot CLI and Gemini CLI also recognise `~/.agents/skills/` as a cross-runtime alias.
...
- ✅ Good: `**REQUIRED BACKGROUND:** You MUST understand diagnose`
