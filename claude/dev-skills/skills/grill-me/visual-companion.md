...
#           "screen_dir":"/path/to/project/.ai-workflow/brainstorm/12345-1706000000/content",
#           "state_dir":"/path/to/project/.ai-workflow/brainstorm/12345-1706000000/state"}
```
...
If the session used `--project-dir`, mockup files persist in `.ai-workflow/brainstorm/` for later reference. Only `/tmp` sessions get deleted on stop.
