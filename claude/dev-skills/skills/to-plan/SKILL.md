...
> **For agentic workers:** REQUIRED SUB-SKILL: Use to-implement to build this plan task by task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** [One sentence describing what this builds]

**Observable outcome:** [What works end to end once this lands, and exactly how to
observe it — the command, the screen, the request, the build. The whole-branch
review drives this; a plan that cannot name it has no runtime gate.]
...
Present the plan and take approval before any of it is built. Show:

- the task list, one line each;
- the **Observable outcome**;
- anything you resolved by your own judgement rather than from the spec.
